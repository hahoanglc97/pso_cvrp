...
public class Simulator {
    ...
    public final static int K = 3;  // no of vehicle

    private final static int MAX_STORE_DEMAND = 10;
    private final static int MAX_STORE_RECYCLABLES = 5;

    public final static int N = 5;  // no of particles in swarm
    public final static int T = 120;  // iteration count
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        //Initializations
        System.out.println("---------------------------------------------------------");
        System.out.println("Distribution Model");
        System.out.println("---------------------------------------------------------");
        ...
        particleGraph.pack();
        UIUtils.centerFrameOnScreen(particleGraph);
